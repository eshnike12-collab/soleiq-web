...
// The site imports this as a default (`import Cursor from ...`), which is how
// it was exported before this rewrite. Both forms are exported so neither
// import style breaks.
