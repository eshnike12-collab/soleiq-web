    ...
    return (
      <div className="min-h-screen bg-[#f4f6f8] px-5 py-8">
        <main className="mx-auto max-w-3xl rounded-3xl border border-slate-200 bg-white p-7 text-center">
          <h1 className="text-xl font-semibold text-slate-950">Report unavailable</h1>
        ...
        <article className="mt-4 rounded-3xl border border-slate-200 bg-white p-7">
          ...
          {report.photos.length > 0 && (
            <section className="mt-6">
              <h2 className="font-semibold">Photos from this check</h2>
          ...
          {isClinician && clinical && (
            <section className="mt-6 rounded-2xl border border-indigo-100 bg-indigo-50/50 p-5">
              ...
              {(clinical?.findings ?? []).map((finding: any, index: number) => (
                <div key={index} className="mt-3 rounded-2xl border border-indigo-100 bg-white p-4">
