...
export function FlowShell({ children }: { children: ReactNode }) {
  return (
    <div className="h-screen w-full bg-[#f4f6f8] supports-[height:100dvh]:h-[100dvh]">
      <div className="relative mx-auto h-full w-full max-w-2xl overflow-hidden bg-white md:border-x md:border-slate-200">
        {children}
      </div>
    </div>
  );
